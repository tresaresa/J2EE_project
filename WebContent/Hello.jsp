    ...
    <main role="main">
      <div class="jumbotron first-section">
        <div class="container">
          ...
          <p class="display-text">
          	欢迎来到东方体育中心，您可以在此管理新闻，了解场馆信息，进行场馆预约以及进行留言。
          </p>
          <p class="display-text">祝您健身愉快！</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h3>新闻</h3>
            <p class="display-text">在这里您可以查询最新的场馆动态以及新闻。</p>
            <p><a class="btn btn-secondary btn-next" href="news.jsp" role="button">查看更多</a></p>
          </div>
          <div class="col-md-4">
            <h3>场馆介绍</h3>
            <p class="display-text">东方体育中心拥有国际标准的篮球馆、乒乓球馆、羽毛球馆和排球馆，欢迎点击查询更多信息。</p>
            <p><a class="btn btn-secondary btn-next" href="rvnintro.jsp" role="button">查看更多</a></p>
          </div>
          <div class="col-md-4">
            <h3>留言板</h3>
            <p class="display-text">如有任何问题想要反馈或者与网友分享，欢迎在此留言。</p>
            <p><a class="btn btn-secondary btn-next" href="messageboard.jsp" role="button">查看更多</a></p>
          </div>
        </div>
        <hr>
      </div>
